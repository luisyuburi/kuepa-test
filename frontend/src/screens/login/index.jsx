...
export default function SignIn(props) {
  ...
  const Login = async (e) => {
    ...
    if (
      ...
      newValidator["email"] = "Ambos campos son obligatorios";
    ...
    if (!validator.isEmail(userData.email)) {
      const newValidator = { ...validation };
      newValidator["email"] = "El email es incorrecto";
      setValidation(newValidator);
      return;
    }
    ...
    auth.signin(userData, (response) => {
      if (response.status === 200) {
        ...
        const newValidator = { ...validation };
        newValidator["email"] = "Las credenciales son incorrectas";
        setValidation(newValidator);
        return;
      } else {
        const newValidator = { ...validation };
        newValidator["email"] = "Ha ocurrido un error";
        setValidation(newValidator);
        return;
      }
    });
